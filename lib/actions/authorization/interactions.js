...
module.exports = async function interactions(resumeRouteName, ctx, next) {
  ...
  if (!prompt) {
    ...
    const rpoidcScopes = oidc.requestParamOIDCScopes
    const getOidcSco = oidc.grant.getOIDCScopeFiltered(rpoidcScopes)
    console.log('oidc.requestParamOIDCScopes')
    console.log(rpoidcScopes)
    console.log('Primera parte del if:')
    console.log(getOidcSco)
    console.log('Primera parte del if negada:')
    console.log(!getOidcSco)
    console.log('ResourceServers:')
    console.log(JSON.stringify(ctx.oidc.resourceServers))
    console.log('requestParamScopes: ')
    console.log(oidc.requestParamScopes)
